...
//  nutesapp
//
//  Created by Gary Piong on 24/02/19.
...
final class DirectMessageViewController: ChatViewController {
...
//            })
    ...
    override func loadFirstMessages() {
        ...
        chatManager.getMessages(chatID: chatID) { (messages) in
...
//        messageInputBar.inputTextView.tintColor = .primaryColor
    ...
    private func configureInputBarItems() {
        ...
        messageInputBar.sendButton.image = UIImage(named: "Next_Arrow")
...
//    }
    ...
    func configureAvatarView(_ avatarView: AvatarView, for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) {
        ...
        if let url = user?.url {
            avatarView.sd_setImage(with: URL(string: url))
        }
        
        avatarView.isHidden = isNextMessageSameSender(at: indexPath)
        avatarView.layer.borderWidth = 2
        avatarView.layer.borderColor = UIColor.onlineColor.cgColor
    }
